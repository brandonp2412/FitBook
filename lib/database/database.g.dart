...
class $SettingsTable extends Settings with TableInfo<$SettingsTable, Setting> {
  ...
  static const VerificationMeta _autoCalcMeta =
      const VerificationMeta('autoCalc');
  @override
  late final GeneratedColumn<bool> autoCalc = GeneratedColumn<bool>(
      'auto_calc', aliasedName, false,
      type: DriftSqlType.bool,
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("auto_calc" IN (0, 1))'),
      defaultValue: const Constant(false));
  ...
  late final GeneratedColumn<int> dailyProtein = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: false);
  static const VerificationMeta _dailyFiberMeta =
      const VerificationMeta('dailyFiber');
  @override
  ...
  late final GeneratedColumn<String> themeMode = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _navigationAnimationMeta =
      const VerificationMeta('navigationAnimation');
  @override
  late final GeneratedColumn<String> navigationAnimation =
      GeneratedColumn<String>('navigation_animation', aliasedName, false,
          type: DriftSqlType.string,
          requiredDuringInsert: false,
  ...
  late final GeneratedColumn<bool> scrollableTabs = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(true));
  static const VerificationMeta _compactDiaryMeta =
      const VerificationMeta('compactDiary');
  @override
  late final GeneratedColumn<bool> compactDiary = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(true));
  static const VerificationMeta _compactWeightsMeta =
      const VerificationMeta('compactWeights');
  @override
  late final GeneratedColumn<bool> compactWeights = GeneratedColumn<bool>(
  ...
  late final GeneratedColumn<bool> graphsStartAtZero = GeneratedColumn<bool>(
      ...
      defaultValue: const Constant(false));
  static const VerificationMeta _graphSeriesMeta =
      const VerificationMeta('graphSeries');
  @override
  late final GeneratedColumn<String> graphSeries = GeneratedColumn<String>(
      'graph_series', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant('value,goal'));
  @override
  List<GeneratedColumn> get $columns => [
        curveLines,
        autoCalc,
  ...
  VerificationContext validateIntegrity(Insertable<Setting> instance,
    ...
    if (data.containsKey('auto_calc')) {
      context.handle(_autoCalcMeta,
          autoCalc.isAcceptableOrUnknown(data['auto_calc']!, _autoCalcMeta));
    }
    ...
    if (data.containsKey('daily_fiber')) {
      context.handle(
          _dailyFiberMeta,
          dailyFiber.isAcceptableOrUnknown(
              data['daily_fiber']!, _dailyFiberMeta));
    }
    ...
    if (data.containsKey('navigation_animation')) {
      context.handle(
          _navigationAnimationMeta,
    ...
    if (data.containsKey('compact_diary')) {
      context.handle(
          _compactDiaryMeta,
          compactDiary.isAcceptableOrUnknown(
              data['compact_diary']!, _compactDiaryMeta));
    }
    if (data.containsKey('compact_weights')) {
      context.handle(
          _compactWeightsMeta,
    ...
    if (data.containsKey('graph_series')) {
      context.handle(
          _graphSeriesMeta,
          graphSeries.isAcceptableOrUnknown(
              data['graph_series']!, _graphSeriesMeta));
    }
    return context;
  }
  ...
  Setting map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Setting(
      ...
      autoCalc: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}auto_calc'])!,
      ...
      graphSeries: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}graph_series'])!,
    );
  }
...
class Setting extends DataClass implements Insertable<Setting> {
  ...
  const Setting(
      ...
      required this.graphSeries});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['curve_lines'] = Variable<bool>(curveLines);
    map['auto_calc'] = Variable<bool>(autoCalc);
    ...
    map['graph_series'] = Variable<String>(graphSeries);
    return map;
  }
  ...
  factory Setting.fromJson(Map<String, dynamic> json,
    ...
    return Setting(
      ...
      autoCalc: serializer.fromJson<bool>(json['autoCalc']),
      ...
      graphSeries: serializer.fromJson<String>(json['graphSeries']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'autoCalc': serializer.toJson<bool>(autoCalc),
      ...
      'graphSeries': serializer.toJson<String>(graphSeries),
    };
  }
  ...
  Setting copyWith(
      ...
      Setting(
        ...
        graphSeries: graphSeries ?? this.graphSeries,
      );
  Setting copyWithCompanion(SettingsCompanion data) {
    return Setting(
      ...
      graphSeries:
          data.graphSeries.present ? data.graphSeries.value : this.graphSeries,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is Setting &&
          ...
          other.graphSeries == this.graphSeries);
}

class SettingsCompanion extends UpdateCompanion<Setting> {
  final Value<bool> curveLines;
  final Value<bool> autoCalc;
  ...
  final Value<String> graphSeries;
  const SettingsCompanion({
    ...
    this.graphSeries = const Value.absent(),
  });
  ...
  static Insertable<Setting> custom({
    ...
    return RawValuesInsertable({
      ...
      if (graphSeries != null) 'graph_series': graphSeries,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (autoCalc.present) {
      map['auto_calc'] = Variable<bool>(autoCalc.value);
    }
    ...
    if (compactDiary.present) {
      map['compact_diary'] = Variable<bool>(compactDiary.value);
    }
    ...
    if (graphSeries.present) {
      map['graph_series'] = Variable<String>(graphSeries.value);
    }
    return map;
  }
...
class $MealFoodsTable extends MealFoods
  ...
  @override
  VerificationContext validateIntegrity(Insertable<MealFood> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (diariesRefs)
                    await $_getPrefetchedData<Food, $FoodsTable, Diary>(
                        currentTable: table,
                        referencedTable:
                            $$FoodsTableReferences._diariesRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$FoodsTableReferences(db, table, p0).diariesRefs,
                  ...
                  if (mealFoodsRefs)
                    await $_getPrefetchedData<Food, $FoodsTable, MealFood>(
                        currentTable: table,
                        referencedTable:
                            $$FoodsTableReferences._mealFoodsRefsTable(db),
                        managerFromTypedResult: (p0) =>
              ...
              addJoins: <
                ...
                if (food) {
                  state = state.withJoin(
                    ...
                    referencedTable: $$DiariesTableReferences._foodTable(db),
                    referencedColumn:
...
class $$SettingsTableFilterComposer
  ...
  ColumnFilters<bool> get autoCalc => $composableBuilder(
      column: $table.autoCalc, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<int> get dailyFiber => $composableBuilder(
      column: $table.dailyFiber, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<bool> get compactDiary => $composableBuilder(
      column: $table.compactDiary, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get graphSeries => $composableBuilder(
      column: $table.graphSeries, builder: (column) => ColumnFilters(column));
}
...
class $$SettingsTableOrderingComposer
  ...
  ColumnOrderings<bool> get autoCalc => $composableBuilder(
      column: $table.autoCalc, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<int> get dailyFiber => $composableBuilder(
      column: $table.dailyFiber, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get navigationAnimation => $composableBuilder(
      column: $table.navigationAnimation,
      builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<bool> get compactDiary => $composableBuilder(
      column: $table.compactDiary,
      builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get graphSeries => $composableBuilder(
      column: $table.graphSeries, builder: (column) => ColumnOrderings(column));
}
...
class $$SettingsTableAnnotationComposer
  ...
  GeneratedColumn<bool> get autoCalc =>
      $composableBuilder(column: $table.autoCalc, builder: (column) => column);
  ...
  GeneratedColumn<int> get dailyFiber => $composableBuilder(
      column: $table.dailyFiber, builder: (column) => column);
  ...
  GeneratedColumn<bool> get compactDiary => $composableBuilder(
      column: $table.compactDiary, builder: (column) => column);
  ...
  GeneratedColumn<String> get graphSeries => $composableBuilder(
      column: $table.graphSeries, builder: (column) => column);
}
  ...
  $$SettingsTableTableManager(_$AppDatabase db, $SettingsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<bool> autoCalc = const Value.absent(),
            Value<int?> dailyCalories = const Value.absent(),
            Value<int?> dailyCarb = const Value.absent(),
            Value<int?> dailyFat = const Value.absent(),
            Value<int?> dailyProtein = const Value.absent(),
            ...
            Value<String> graphSeries = const Value.absent(),
          }) =>
              SettingsCompanion(
...
class $$MealFoodsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $MealFoodsTable,
    MealFood,
    $$MealFoodsTableFilterComposer,
    ...
    MealFood,
    PrefetchHooks Function({bool meal, bool food})> {
  $$MealFoodsTableTableManager(_$AppDatabase db, $MealFoodsTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({meal = false, food = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins: <
                ...
                if (meal) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.meal,
                    referencedTable: $$MealFoodsTableReferences._mealTable(db),
                    referencedColumn:
                        $$MealFoodsTableReferences._mealTable(db).id,
                  ) as T;
                }
                if (food) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.food,
                    referencedTable: $$MealFoodsTableReferences._foodTable(db),
                    referencedColumn:
                        $$MealFoodsTableReferences._foodTable(db).id,
                  ) as T;
                }
...
typedef $$MealFoodsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $MealFoodsTable,
    MealFood,
    $$MealFoodsTableFilterComposer,
