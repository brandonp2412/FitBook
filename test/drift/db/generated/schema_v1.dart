  ...
  FoodsData copyWithCompanion(FoodsCompanion data) {
    return FoodsData(
      ...
      vitaminAIuIu: data.vitaminAIuIu.present
          ...
          : this.vitaminAIuIu,
      vitaminAReaMcg: data.vitaminAReaMcg.present
          ? data.vitaminAReaMcg.value
          : this.vitaminAReaMcg,
      vitaminCMg:
      ...
      panthothenicAcidB5Mg: data.panthothenicAcidB5Mg.present
          ? data.panthothenicAcidB5Mg.value
          : this.panthothenicAcidB5Mg,
      vitaminB6Mg:
      ...
      theobromingMg: data.theobromingMg.present
          ? data.theobromingMg.value
          : this.theobromingMg,
